...
cluster-tf: ## Applies module 'cluster-single'
	@terraform init -upgrade                                                             \
	 && terraform apply -auto-approve -target=module.cluster-single
...
cluster-dev: ## Applies module 'cluster-dev'
	@terraform init -upgrade                                                             \
	 && terraform apply -auto-approve -target=module.cluster-dev

cluster-stage: ## Applies module 'cluster-stage'
	@terraform init -upgrade                                                             \
	 && terraform apply -auto-approve -target=module.cluster-stage

cluster-prod: ## Applies module 'cluster-prod'
	@terraform init -upgrade                                                             \
	 && terraform apply -auto-approve -target=module.cluster-prod

cluster-gitops: ## Applies module 'cluster-gitops'
	@terraform init -upgrade                                                             \
	 && terraform apply -auto-approve -target=module.cluster-gitops
